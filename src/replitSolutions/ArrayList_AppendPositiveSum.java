...
public class ArrayList_AppendPositiveSum {
    public static void main(String[] args) {

        ArrayList<Integer> list = new ArrayList<>(Arrays.asList(4,-6,3,-8,0,4,3));

        System.out.println(appendPositiveSum(list));


    }

    public static ArrayList<Integer> appendPositiveSum (ArrayList<Integer> list ) {
...
the ArrayList that gets returned should be (4,3,4,3,14), with 14 being the sum of (4,3,4,3). The original ArrayList
